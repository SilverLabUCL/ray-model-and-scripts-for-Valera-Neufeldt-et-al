function [OP,Scan,DC,Z,Exp] = setup_FigS10d(mainFolder)
...
Exp.dataLocation = [mainFolder,path_for_figures,'FigureS10d/'];
Exp.fileName = 'yScan_aa0_005_dt2e-07_1_Tracks.xml';
