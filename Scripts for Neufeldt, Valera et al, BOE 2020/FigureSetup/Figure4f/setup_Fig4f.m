function [OP,Scan,DC,Z,Exp] = setup_Fig4f(mainFolder)
...
Scan.Curvature = linspace(0.91,-0.79,81);             % Wavefront curvature in m^-1
...
OP.xError = 0e-3;
OP.yError = 0e-3;
OP.zError = -83e-3;         OP.zError = OP.zError + (OP.zError==0)*eps;
...
Exp.dataLocation = [mainFolder,path_for_figures,'Figure4f/'];
Exp.fileName = 'Fig4f_xScan_f_750.xml';
Exp.numberPlanes = 71;
