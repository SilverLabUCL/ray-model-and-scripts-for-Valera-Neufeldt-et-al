function [OP,Scan,DC,Z,Exp] = setup_Fig3d(mainFolder)
...
Scan.Curvature = linspace(0.898,-0.8,81);             % Wavefront curvature in m^-1
...
%% Lateral and axial misalignment of the AOL
OP.xError = 2.19e-3;
OP.yError = 1.29e-3;
OP.zError = -69e-3;         OP.zError = OP.zError + (OP.zError==0)*eps;
...
Exp.dataLocation = [mainFolder,path_for_figures,'Figure3d/'];
Exp.fileName = 'Fig3d_xScan_aa0_005_dt1e-07_Tracks.xml';
