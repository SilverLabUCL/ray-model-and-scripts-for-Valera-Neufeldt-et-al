function [OP,Scan,DC,Z,Exp] = setup_Fig5d(mainFolder)
...
%% Scan Parameters
Scan.AccAngle = 8e-3;            % Acceptance angle in rad, single element or array
...
Exp.dataLocation = [mainFolder,path_for_figures,'Figure5d/'];
Exp.fileName = 'Fig5d_yScan_aa0_008_dt5e-08_Tracks.xml';
