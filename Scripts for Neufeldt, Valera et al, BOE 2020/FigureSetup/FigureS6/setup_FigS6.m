function [OP,Scan,DC,Z] = setup_FigS6
...
DC.zCorrection = true;           % Correct for non-linear z-spacing and magnification distortion
DC.xyCorrection = true;          % Correct for skew distortion
DC.MagCorrectionFactor = 26.67;  % Magnification distortion correction factor abs. min. value = 1
xCorr = -3.25; yCorr = -3.25; xCorr_sine = 0; yCorr_sine = 0;   % Skew distortion correction factors
