function [OP,Scan,DC,Z,Exp] = setup_FigS7b(mainFolder)
...
Exp.dataLocation = [mainFolder,path_for_figures,'FigureS7b/'];
Exp.fileName = 'FigS7b_xScan_aa0_005_dt1e-07_Tracks.xml';
