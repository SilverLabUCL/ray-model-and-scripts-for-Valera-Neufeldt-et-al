function [OP,Scan,DC,Z,FT] = setup_default
...
Scan.timePoints = linspace(-0.45,0.45,5);       % Time points at which to sample the modelled raster scan
Scan.Curvature = linspace(0.8775,-0.8775,11);   % Wavefront curvature in m^-1

%% FT Model Parameters
FT.FT_Model = false;             % Use FFT focus finder
FT.TwoPhoton = true;             % Single/two photon PSF (false/true)
FT.N = 2*256;                    % FFT sampling
